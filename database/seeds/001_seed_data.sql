...
(
    ...
    'Admin',
    'admin@twzltd.com',
    '$2a$10$uZM01U33TkBmFhPwPIhdxeJygnLhEmGqVlSi0176sUEghawpsBYnG',
    'admin',
    '+250788000001',
    'IT Administration'
),
(
    ...
    '$2a$10$.AmokiDL2YVwHjFhZDnwFOp6JZOE7FMvoGYtdfoBpuk4rPE7m/XSW',
    'inspector',
    '+250788000002',
    'Safety & Compliance'
),
(
    ...
    'Viewer',
    'user@twzltd.com',
    '$2a$10$XC5IquKxsaiduTvrAAhNTu65lDIyiqq7gXZ/fHCSqlry6au1arDiO',
    'user',
    '+250788000003',
    'Facilities'
);
