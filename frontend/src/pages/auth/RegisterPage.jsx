...
import { Flame, Eye, EyeOff, UserPlus, AlertCircle, CheckCircle2 } from 'lucide-react';
            ...
            <form onSubmit={handleSubmit(onSubmit)} className="space-y-4">
              <div className="grid grid-cols-2 gap-4">
                <div>
                  ...
                  <input {...register('first_name')} className={`input-field ${errors.first_name ? 'border-red-400' : ''}`} placeholder="John" />
                  {errors.first_name && <p className="text-red-500 text-xs mt-1">{errors.first_name.message}</p>}
                </div>
                <div>
                  <label className="label">Last Name *</label>
                  <input {...register('last_name')} className={`input-field ${errors.last_name ? 'border-red-400' : ''}`} placeholder="Doe" />
              ...
              <div>
                ...
                <input {...register('email')} type="email" className={`input-field ${errors.email ? 'border-red-400' : ''}`} placeholder="john@example.com" />
              ...
              <div className="grid grid-cols-2 gap-4">
                ...
                <div>
                  ...
                  <input {...register('department')} className="input-field" placeholder="Facilities" />
                </div>
              </div>
              ...
              <div>
                ...
                <div className="relative">
                  <input {...register('password')} type={showPass ? 'text' : 'password'} className={`input-field pr-10 ${errors.password ? 'border-red-400' : ''}`} placeholder="Min 8 chars with uppercase, number & symbol" />
              ...
              <div>
                ...
                <input {...register('confirm_password')} type="password" className={`input-field ${errors.confirm_password ? 'border-red-400' : ''}`} placeholder="Repeat password" />
